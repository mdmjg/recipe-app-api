...
class PrivateRecipeApiTest(TestCase):
    """Tests unauthenticated recipe access"""

    def setUp(self):
        self.client = APIClient()
        self.user = get_user_model().objects.create_user(
            "test@medellin.com", "password"
        )
    ...
    def test_recipes_limited_to_user(self):
        ...
        user2 = get_user_model().objects.create_user("other@medellin.com", "password")
    ...
    def test_create_basic_recipe(self):
        ...
        payload = {"title": "Test recipe", "time_minutes": 10, "price": 10.00}
    ...
    def test_create_recipe_with_ingredients(self):
        ...
        ing2 = sample_ingredient(user=self.user, name="Pickles")
        payload = {
            "title": "Test recipe",
            "time_minutes": 10,
            "price": 10.00,
    ...
    def test_partial_update_recipe(self):
        """Testing updating recipe with patch"""
        recipe = sample_recipe(user=self.user)
        recipe.tags.add(sample_tag(user=self.user))
    ...
    def test_full_update_recipe(self):
        ...
        recipe = sample_recipe(user=self.user)
        recipe.tags.add(sample_tag(user=self.user))
        payload = {"title": "Yummy Soup", "time_minutes": 10, "price": 5.00}
        url = detail_url(recipe.id)
